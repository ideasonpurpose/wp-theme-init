...
class TwoFactor
{
     ...
     */
    public function tokenEmail(string $message, string $token, $user_id)
    {
        $name = apply_filters(
        ...
        $this->token = $token;
        add_filter('wp_mail', [$this, 'rewriteSubject']);
     ...
     * }
     */
    public function rewriteSubject($args)
    {
        $args['subject'] = "{$this->token} is your login code";
        return $args;
    }
}
