...
- **Two Factor**  
  Sets emailed token length to 6 characters. Optionally enforces email MFA for all admin users. Disables MFA for development environments by substituting the `Two_Factor_Dummy` Provider. 
